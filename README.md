...
| ----------- | ------------- | -------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------- |
| **Windows** | 10, 11        | x86, 64-bit          | `.exe`    | [Download](https://github.com/zuccha/rom-hack-manager/releases/download/2.1.0/rom-hack-manager_2.1.0_win.zip)           |
| **Windows** | 7 or newer    | x86, 64-bit          | Installer | [Download](https://github.com/zuccha/rom-hack-manager/releases/download/2.1.0/rom-hack-manager_2.1.0_win_installer.zip) |
| **macOS**   | 10.3 or newer | Intel, Apple Silicon | `.app`    | [Download](https://github.com/zuccha/rom-hack-manager/releases/download/2.1.0/rom-hack-manager_2.1.0_macos.zip)         |
